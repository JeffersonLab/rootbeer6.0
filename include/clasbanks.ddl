...
!
  ...
  3  Mass     F     0.   10.     ! mass squared (from SEB =p**2(1.-beta**2)/beta**2) 
  4  Charge   I    -1     1      ! charge (from tracking)
  5  Beta     F     0.    1.     ! Particle velocity in the units of c (=R_trk/TOF/c)
...
!
  ...
  2  ntrk       I   1       100     ! number of tracks used to make vertex
...
!
  ...
  4  charge   I    -1.    1.     ! charge (get from tracking)
  5  Status   I     0   0xFFFF   ! Status word (not defined yet)
!
!    RELations:
!    ----------
!COL RELname  RELtype INTbank  ! Comments
...
!
  ...
  5  length    F  -200.  200.  ! lenght of target
